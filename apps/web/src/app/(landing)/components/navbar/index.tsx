...
const Navbar = () => {
  ...
  return (
    <motion.div
      ...
      className="fixed max-w-3xl w-full justify-self-center z-50 top-6 left-0 right-0 rounded-full p-[2px] bg-linear-to-r from-primary/20 via-secondary/20 to-primary/20"
    >
