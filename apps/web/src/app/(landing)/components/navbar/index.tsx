    ...
    <>
      ...
      >
        <div className="rounded-full p-[2px] bg-linear-to-r from-primary/20 via-secondary/20 to-primary/20">
          <nav className="w-full h-full rounded-full bg-white/80 backdrop-blur-xl flex items-center shadow-lg">
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            <div className="bg-white/95 backdrop-blur-xl rounded-2xl shadow-xl p-4">
